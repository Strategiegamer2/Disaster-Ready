...
public class DisplayResults : MonoBehaviour
{
    ...
    public TextMeshProUGUI task3Text;       // UI element to display Task 3 completion
    ...
    public TextMeshProUGUI task3ExplanationText;  // UI element for Task 3 explanation
    ...
    void Start()
    {
        ...
        int task3Complete = PlayerPrefs.GetInt("Task3Complete", 0); // New for Task 3

        // Display total points
        pointsText.text = "Total Points: " + totalPoints;

        // Display task completion statuses and explanations for Task 1
        if (task1Complete == 1)
        {
        ...
        // Display task completion statuses and explanations for Task 2
        if (task2Complete == 1)
        {
        ...
        // Display task completion statuses and explanations for Task 3
        if (task3Complete == 1)
        {
            task3Text.text = "Close all doors and windows: Completed";
            task3ExplanationText.text = "Task 3: You have ensured all doors and windows are closed, reducing potential water entry.";
        }
        else
        {
            task3Text.text = "Close all doors and windows: Not Completed";
            task3ExplanationText.text = "Task 3: Make sure all doors and windows are securely closed to prevent water from entering.";
        }
    }
}
